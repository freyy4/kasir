    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-justify my-auto">
                <span>
                    <marquee behavior="alternate"><?php echo date('Y');?> - Sistem Penjualan Barang dari <b>Farid Syifa Arrahim</b>
                    Follow My Instagram In <b><a href="https://instagram.com/f_syi19" target="_blank">f_syi19</a></b></marquee>
                </span>
            </div>
        </div>
    </footer>
